...
This workflow is <span style="color: #EA4335;">incredibly time-consuming and costly</span>. It's also inherently <span style="color: #EA4335;">limited by human cognitive bandwidth</span>. An analyst might miss a crucial detail buried in a footnote on page 87 of a 10-Q, an oversight that could have profound financial consequences.

### Our Architectural Thesis: <span style="color: #4285F4;">RAG + Agents</span>
...
- **Time Reduction:** `800 hours × (1 - 0.65) = 280 hours`
- **New Cost:** `280 hours × $300/hour = $84,000`  
- **Savings per Memo:** `$240,000 - $84,000 = $156,000`
- **Annual Savings:** `$156,000 × 1,000 cases = $156,000,000`
...
*   **Average Case Profit:** We'll model this on a mid-sized case with a projected profit of **$10 million**.
...
**Value Generation Calculation:**
- **Per Insight Value:** `$10M × 1% = $100,000`
